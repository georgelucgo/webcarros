      ...
      <Container>
       ...
       { car && (
        <main className="w-full bg-white rounded-lg p-6 my-4">
          ...
          className="bg-green-500 w-full text-white flex items-center justify-center gap-2 my-6 h-11 text-xl rounded-lg font-medium cursor-pointer">Conversar com vendedor 
