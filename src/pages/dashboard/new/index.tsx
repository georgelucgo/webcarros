...
const schema = z.object({
  ...
  whatsapp: z.string().min(1,'O Telefone é obrigatório').refine((value)=> /^(\d{10,12})$/.test(value),{ // Regex
          ...
          <form className='w-full' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex w-full mb-3 flex-row items-center gap-4">
                ...
                <div className="w-full">
                    ...
                    <Input type='text' register={register} name='whatsapp' error={errors.whatsapp?.message} placeholder="Ex: 011999101923" />
                </div>

                <div className="w-full">
                    <p className="mb-2 font-medium">Cidade</p>
                    <Input type='text' register={register} name='city' error={errors.city?.message} placeholder="Ex: Campo Grande - MS" />
                </div>
            ...
            <div className="mb-3">
                ...
                <textarea className="border-2 w-full rounded-md  h-24 px-2" {...register('description')} name='description' id='description'  placeholder="Digite a descrição completa sobre o carro..."></textarea>
            </div>
